...
export default function Navbar() {
  ...
  return (
    <nav className="bg-[#43698e] fixed w-full top-0 z-50">
                    ...
                    <div className="space-y-6 px-4">
                      <div className="space-y-3">
                        <ul className="space-y-2">
                          ...
                          <li><Link href="/api/auth/signup" className="text-gray-300 hover:text-white transition-colors block py-1">Get Started</Link></li>
                        </ul>
                      </div>
                    </div>
                  </div>
